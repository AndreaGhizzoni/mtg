...
//===========================================================================================
	...
	public synchronized HashSet<MTGCard> getAllCards(){
		return this.mtgSet;
	}

	/** @return {@link List} of all saved card. */
	public synchronized List<MTGCard> getAllCardsAsList(){
		return new ArrayList<>( this.mtgSet );
	}

	/** @return {@link List} list of inserted series. */
	public synchronized List<String> getInsertedSeries(){
	...
	public synchronized List<String> getInsertedSubTypes(){
