...
/**
 * Panel to get the baic info of MTG card. 
 *  
...
public class MTGBasicInfo extends JPanel
{
	...
	private void initContent(){
		...
		add(label, "cell 6 1,alignx trailing");
		this.txtSeries = new JTextField();
		add(txtSeries, "cell 7 1 2 1,growx");
...
//===========================================================================================
	 ...
	 */
	public void setIsLegendaryEnable( boolean t ){ this.chbIsLegendary.setEnabled( t ); }
	
	/**
	 * Set the component enable or not
	 */
	public void setIsArtifactEnable( boolean t ){ this.chbIsArtifact.setEnabled( t ); }
...
//===========================================================================================
	 ...
	 */
	public Rarity getRarity(){ return (Rarity)this.cmbRarity.getSelectedItem(); }
...
//		return mtgCardColor;ù
	 ...
	 */
	public boolean isLegendarySelected(){ return this.chbIsLegendary.isSelected(); }
